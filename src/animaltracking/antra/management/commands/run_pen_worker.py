...
from antra.models import PenState
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--lost-track-buffer", type=int, default=30, help="ByteTrack lost track buffer in frames.")
    ...
    def update_distance_metrics(
        ...
        previous_tracking_state = pen_state.tracking_state_json if isinstance(pen_state.tracking_state_json, dict) else {}
